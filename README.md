...
I think i change `.env` of backend to `AUTH_TYPE=LOCAL` and `NEXT_FRONTEND_URL=http://0.0.0.0:3000` which not good for security but at least the first installation is work :)
